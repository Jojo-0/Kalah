// copied from https://github.com/KlnSdr/AOP_SoSe23/blob/main/src/Sinking/common/Classloader.java
...
public abstract class Classloader<T> {
    ...
    private Set<Class<? extends T>> loadClassesFromDirectory() {
        ...
        if (istream == null) {
            throw new RuntimeException("Could not load classes. Package " + packageName + " not found.");
        }
